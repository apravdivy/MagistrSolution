    ...
    public partial class MainForm : Form
    {
        ...
        private void btnDo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double result = Solver.SolveMin(0, l, TargetFunctional, 0.0001);
        ...
        {
            Dictionary<double, List<double>> calaculatedSensorsResults = GetValue(l1, ro1, c1, l2, ro2, c2, tl,
                                                                                  t0, tr, l, ksi, nodesCount,
                                                                                  sensorsCount, false);
            return Diff(calaculatedSensorsResults, sensorsResults);
        }
        ...
        private void RAlgFunction(ref double f, ref double[] x, ref double[] g)
        {
            ...
            g[1] = (TargetFunctional(x[0], x[1] + delta, x[2]) - f) / delta;
            g[2] = (TargetFunctional(x[0], x[1], x[2] + delta) - f) / delta;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ra.FUNCT = new RAlgSolver.RAlgFunctionDelegate(RAlgFunction);
            ra.R_Algorithm();
