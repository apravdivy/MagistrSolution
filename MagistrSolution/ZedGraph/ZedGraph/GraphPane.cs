...
namespace ZedGraph
{
    ...
    public class GraphPane : PaneBase, ICloneable, ISerializable
    {
        ...
        private readonly Y2AxisList _y2AxisList;
        ...
        private readonly YAxisList _yAxisList;
        ...
        /// </summary>
        private readonly ZoomStateStack _zoomStack;
        ...
        public override void Draw(Graphics g)
        {
            ...
            _chart.Border.Draw(g, IsPenWidthScaled, scaleFactor, _chart._rect);
